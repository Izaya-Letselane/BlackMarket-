...
import { TrustStrip } from "../components/TrustsStrip"
import { useHomeCatalog } from "../hooks/useHomeCatalog"
import { PageError } from "../components/PageError";
import { CatalogProductCard } from "../components/CatalogProductCard";

const HomePage = () => {
    const {products,categoryFilter, categories, categoryChipsLoading,error,loadingCategories, loadingList,setCategory}= useHomeCatalog()
  return (
