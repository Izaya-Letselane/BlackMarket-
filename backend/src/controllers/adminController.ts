...
export function getImageKitAuth(_req: express.Request, res: express.Response, next: express.NextFunction) {
  try {
...
export async function listAdminProducts(_req: express.Request, res: express.Response, next: express.NextFunction) {
  try {
...
export async function createAdminProduct(req: express.Request, res: express.Response, next: express.NextFunction) {
  try {
...
export async function updateAdminProduct(req: express.Request, res: express.Response, next: express.NextFunction) {
  try {
...
export async function deleteAdminProduct(req: express.Request, res: express.Response, next: express.NextFunction) {
  try {
